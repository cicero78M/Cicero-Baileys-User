...
- **Tambah User Baru**
  ...
  2. Isi nama, pangkat, satfung, dan jabatan sesuai instruksi. Untuk satfung,
     ...
     lengkap. Daftar satfung yang ditampilkan dan divalidasi selalu diambil dari
     data user pada `client_id` yang sama (termasuk client direktorat), sehingga
     pilihan satfung konsisten dengan data client aktif.
